...
useSeoMeta({
  title: `${readableCategory.value} modern rentals`,
...
<template>
  <section class="mx-auto max-w-[1400px] p-6">
    ...
    <div class="mb-8 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
     <div>
        <h1 class="font-bold text-4xl text-gray-900 dark:text-gray-100">{{ readableCategory }} listings</h1>
        <p class="text-gray-600 dark:text-gray-400 mt-2">Find your perfect home in <UBadge :label="readableCategory"  color="neutral"  variant="outline"/> listings</p>
      </div>
